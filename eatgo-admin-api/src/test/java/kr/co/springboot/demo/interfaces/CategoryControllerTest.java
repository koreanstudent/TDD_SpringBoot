...
import kr.co.springboot.demo.application.CategoryService;
import kr.co.springboot.demo.application.RegionService;
...
public class CategoryControllerTest {
    ...
    public void create() throws Exception {
        ...
        Mockito.verify(categoryService).addCategory("Korean Food");
    }
